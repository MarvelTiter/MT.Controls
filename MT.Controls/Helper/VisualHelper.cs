...
namespace MT.Controls.Helper
{
    public static class VisualHelper
    {
        ...
        public static T GetParent<T>(DependencyObject d, Func<DependencyObject, bool> condition = null) where T : DependencyObject
        {
            if (d == null)
            {
                return default;
            ...
            else if (d is T)
            {
                ...
                if (condition.Invoke(d))
                {
                    return (T)d;
                }
                else
                {
                    return GetParent<T>(VisualTreeHelper.GetParent(d), condition);
                }
